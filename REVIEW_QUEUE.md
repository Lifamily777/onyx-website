...
- Family Capital Review decision logic now discards inactive branch answers, distinguishes desired jobs from current evidence and next-dollar choices, requires coherent evidence before GREEN, excludes N/A topics from Decision Intelligence, and provides decision-specific actions and Sammi follow-up questions without recommending a product.
