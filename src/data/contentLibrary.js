import { trustEstateModules } from '../features/onyxProfile/strategies.js'
...
export const trustContentTags = { category: 'tax-architecture', topic: 'trust-estate', subtopics: trustEstateModules.map(item => item.id) }
const externalResources = [
 { id: 'irs-estate-gift', type: 'external', languages: ['en'], categories: ['tax-architecture'], topics: ['trust-estate', ...trustContentTags.subtopics.filter(id => id !== 'special-needs-trust')], audiences: [], generalLearning: true, href: 'https://www.irs.gov/businesses/small-businesses-self-employed/estate-and-gift-taxes', title: { en: 'IRS: Estate and gift taxes', zh: 'IRS：遗产税与赠与税' }, description: { en: 'Official federal resource directory. It does not determine state-law trust validity or individual tax treatment.', zh: '联邦官方资源目录，不判断州法下信托效力或个人税务处理。' } },
 { id: 'ssa-trusts', type: 'external', languages: ['en'], categories: ['tax-architecture'], topics: ['trust-estate','special-needs-trust'], audiences: [], generalLearning: true, href: 'https://www.ssa.gov/ssi/spotlights/spot-trusts.htm', title: { en: 'SSA: SSI Spotlight on Trusts', zh: 'SSA：信托与补充保障收入（SSI）' }, description: { en: 'Official benefits information. Consult qualified legal and benefits professionals about individual circumstances.', zh: '官方福利资料。个人情况应咨询具备资格的法律与福利专业人士。' } },
